...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', isLoading, className, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary-600 hover:bg-primary-700 text-white focus-visible:ring-primary-600',
      secondary: 'bg-neutral-200 hover:bg-neutral-300 text-neutral-900 focus-visible:ring-neutral-400',
      ghost: 'hover:bg-neutral-100 text-neutral-700 focus-visible:ring-neutral-400',
      outline: 'border-2 border-neutral-300 hover:bg-neutral-50 text-neutral-900 focus-visible:ring-neutral-400',
    };
